...
def getUniqueMacId():
	...
	savetxt('UniquemachineId_hour.csv',Id,delimiter=',')
	
def processHourFiles():
	#Variable Initialization
	timeSlotTotalNum=12        			           # user-define value (here represents one week) 
	...
	path_macId="..\\data\\generated_data\\UniquemachineId_hour.csv"  #local path of uniquemachineId
	...
	savetxt('sumOfTimeMachineCPU_hour.csv',timeMacCPUMatrix,delimiter=',') 
	savetxt('sumOfTimeMachineMemo_hour.csv',timeMacMemoMatrix,delimiter=',')
	savetxt('realTimeIdMatrix_hour.csv',realTime_id,delimiter=',',fmt='%s')
